...
SET c1.claim_type = "late_delivery", c1.current_status = "created", c1.priority = "alta",
    c1.order_id = "ORD-1001", c1.purchase_date = "2026-06-20", c1.amount = 349.90;
MATCH (c1:Claim {claim_id: "CLM-20260620-DEMOSEED01"}), (cu:Customer {customer_id: "CUS-001"}) MERGE (c1)-[:REGISTERED_BY]->(cu);
MATCH (c1:Claim {claim_id: "CLM-20260620-DEMOSEED01"}), (p:Product {product_id: "PRD-501"}) MERGE (c1)-[:ABOUT_PRODUCT]->(p);
MATCH (c1:Claim {claim_id: "CLM-20260620-DEMOSEED01"}), (ca:Carrier {carrier_id: "CAR-001"}) MERGE (c1)-[:HANDLED_BY]->(ca);
...
SET c2.claim_type = "defective_product", c2.current_status = "created", c2.priority = "media",
    c2.order_id = "ORD-1010", c2.purchase_date = "2026-06-21", c2.amount = 349.90;
MATCH (c2:Claim {claim_id: "CLM-20260621-DEMOSEED02"}), (cu:Customer {customer_id: "CUS-002"}) MERGE (c2)-[:REGISTERED_BY]->(cu);
MATCH (c2:Claim {claim_id: "CLM-20260621-DEMOSEED02"}), (p:Product {product_id: "PRD-501"}) MERGE (c2)-[:ABOUT_PRODUCT]->(p);
MATCH (c2:Claim {claim_id: "CLM-20260621-DEMOSEED02"}), (ca:Carrier {carrier_id: "CAR-001"}) MERGE (c2)-[:HANDLED_BY]->(ca);
...
SET c3.claim_type = "incorrect_charge", c3.current_status = "created", c3.priority = "alta",
    c3.order_id = "ORD-2001", c3.purchase_date = "2026-06-22", c3.amount = 159.90;
MATCH (c3:Claim {claim_id: "CLM-20260622-DEMOSEED03"}), (cu:Customer {customer_id: "CUS-001"}) MERGE (c3)-[:REGISTERED_BY]->(cu);
MATCH (c3:Claim {claim_id: "CLM-20260622-DEMOSEED03"}), (p:Product {product_id: "PRD-502"}) MERGE (c3)-[:ABOUT_PRODUCT]->(p);
MATCH (c3:Claim {claim_id: "CLM-20260622-DEMOSEED03"}), (ca:Carrier {carrier_id: "CAR-002"}) MERGE (c3)-[:HANDLED_BY]->(ca);
...
SET c4.claim_type = "return_rejected", c4.current_status = "created", c4.priority = "media",
    c4.order_id = "ORD-2010", c4.purchase_date = "2026-06-23", c4.amount = 179.90;
MATCH (c4:Claim {claim_id: "CLM-20260623-DEMOSEED04"}), (cu:Customer {customer_id: "CUS-003"}) MERGE (c4)-[:REGISTERED_BY]->(cu);
MATCH (c4:Claim {claim_id: "CLM-20260623-DEMOSEED04"}), (p:Product {product_id: "PRD-502"}) MERGE (c4)-[:ABOUT_PRODUCT]->(p);
MATCH (c4:Claim {claim_id: "CLM-20260623-DEMOSEED04"}), (ca:Carrier {carrier_id: "CAR-002"}) MERGE (c4)-[:HANDLED_BY]->(ca);
...
SET c5.claim_type = "customer_service", c5.current_status = "created", c5.priority = "baja",
    c5.order_id = "ORD-1020", c5.purchase_date = "2026-06-24", c5.amount = 349.90;
MATCH (c5:Claim {claim_id: "CLM-20260624-DEMOSEED05"}), (cu:Customer {customer_id: "CUS-002"}) MERGE (c5)-[:REGISTERED_BY]->(cu);
MATCH (c5:Claim {claim_id: "CLM-20260624-DEMOSEED05"}), (p:Product {product_id: "PRD-501"}) MERGE (c5)-[:ABOUT_PRODUCT]->(p);
MATCH (c5:Claim {claim_id: "CLM-20260624-DEMOSEED05"}), (ca:Carrier {carrier_id: "SIN_CARRIER"}) MERGE (c5)-[:HANDLED_BY]->(ca);
